...
def prepare_map(mapin='',
    ...
    def determine_extent(numpy_in, tolerance):
        ...
        log_string += '\n  >> First meaningful U: %i ; Last meaningful U: %i' % (min_u, max_u)
        ...
        log_string += '\n  >> First meaningful V: %i ; Last meaningful V: %i' % (min_v, max_v)
...
def run_phaser(phaser_params={ }, callback=_callbacks.interactive_flush):
