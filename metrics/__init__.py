...
from .rotamer import get_cv_score
from .percentiles import get_percentile
from .reflections import ReflectionsHandler
from . import _defs
from .. import utils
...
class MetricsModel(object):
    def __init__(self, mmol_model, reflections_handler=None, multithreaded=True):
        ...
        self.resolution = reflections_handler.resolution_limit

        # Multiprocessing is infeasible because thanks to SWIG bindings
...
class MetricsResidue(object):
    def __init__(self, mmol_residue, index_in_chain=None, previous=None, next=None, parent=None):
        ...
        self.residue_fit_score, self.mainchain_fit_score, self.sidechain_fit_score = None, None, None
        reflections_handler = parent.parent.reflections_handler
        if reflections_handler is not None:
            self.residue_fit_score, self.mainchain_fit_score, self.sidechain_fit_score = reflections_handler.get_density_scores_at_residue(self)
