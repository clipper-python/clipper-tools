...
from ..io.maps import read_xmap
from ..io.molecules import read_pdb
from ..io.map_coefficients import write_to_mtz
...
def cut_by_model(mapin = '',
    ...
    _callbacks.offline_flush(log_string, xml_root)
